...
echo      !!!!!        !!!!!  !!!!!!!!!!!  !!!!!!!!!!!    !!!!       !!!!      !!!!          !!!!   !!!!!!!!!!!
echo.
echo      System utility By Code Suite
timeout 2 >nul
goto vercheck
:vercheck
...
cls
echo.
echo  Please bear with the program- is very big and please troubleshoot.
echo.
menumode 87f6 "                    Click here to go Back"
...
cls
echo.
echo We sadly cannot help you via email etc.
echo.
echo.
menumode 87f6 "                    Click here to go Back"
if %errorlevel%==1 goto helper
...
echo    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
echo.
echo.   Sorry... No Contacts...
echo.
menumode 87f6 "                        Main Menu"
